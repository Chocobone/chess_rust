...
get_board_features()에서 64개의 각 체스 칸(Square)을 하나의 시퀀스로 처리하도록 변환합니다. 
빈칸은 0, 백/흑의 기물은 1~12의 ID를 부여받습니다.
...
Policy Head: 가능한 모든 UCI 이동(vocab 크기, 약 4200여개)에 대한 선택 확률 분포(Logits)를 반환합니다. 
MCTS는 트리 확장을 할 때 이 확률을 가중치(Prior)로 사용합니다.
